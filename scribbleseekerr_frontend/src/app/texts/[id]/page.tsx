  ...
  return (
    <div className="bg-[#0e0e0e] flex flex-col overflow-y-scroll h-screen w-full px-6  sm:px-28 md:px-32 lg:px-36 xl:px-72">
      ...
      <div className="mt-20 w-full bg-[#161616] py-4 px-8 rounded-lg h-fit">
        <Flames scale="scale-110" pk={2} flameUsersProp={[]} />
        <h3
          className={`${PoppinsBold.className} text-gray-100 hidden md:block text-2xl pt-4`}
        >
          This is a title
        </h3>
        <p
          className={`${PoppinsLight.className} text-gray-200 hidden md:block text-xl pt-2 `}
        >

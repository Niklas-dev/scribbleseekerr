    ...
    <>
      ...
      <div className="flex flex-row justify-center gap-2 py-4">
        {!user ? (
          <>
            <Link
              className={`${PoppinsSemi.className} grid items-center text-[#0e0e0e] text-lg bg-gray-100 rounded-md px-6 py-2 transition-transform duration-300 hover:scale-95`}
              href="/login"
            >
              Login
            </Link>
            <Link
              className={`${PoppinsSemi.className} grid items-center text-gray-100 text-lg border-2 border-gray-100 rounded-md px-6 py-2 transition-transform duration-300 hover:scale-95`}
              href="/register"
            >
              Register
            </Link>
